  ...
  return (
    <>
          ...
          <div className="max-w-6xl w-full flex flex-col gap-8">
            <div className="cnts w-full">
              <div className="cr flex flexc-col">
                <h4>
                  <Link className="text-2xl text-black dark:text-white" href="#">
                    Категория 1
                  </Link>
                </h4>
              </div>
              <div className="content grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
                <div className="carde sm:w-full lg:max-w-[370px] border rounded-2xl flex flex-col dark:text-gray-100 bg-white dark:bg-[#111] drop-shadow-lg p-5 border-gray-200">
                  ...
                  <p className="text-sm leading-normal mb-5 text-black dark:text-white">
                    ...
                    практически из любого вида контента: аудио, видео,
                    документы, опросы, SCORM, html-страницы, встроенные
                    материалы из сторонних сервисов: Youtube, Vimeo-видео,
                    Google Forms, Google Docs, LearningApps, H5P и многое-многое
                    другое. А для оценки знаний использовать встроенные
                    инструменты - конструктор тестов и заданий.
                  </p>
                  <Link
      ...
      <Script
        ...
        strategy="lazyOnload"
      >
        67cd357c0ee8663aeac36eb0,67cd355cc999013c53c9221e
      </Script>
    </>
  );
}
